...
public class TicketManagerTest {
    ...
    Ticket ticket4 = new Ticket(4, 10500, "LED", "AER", 4.45);
    ...
    @Test
    public void managerFindFewTest() {
        ...
        Ticket[] actual = manager.findTickets("LED", "SCW");
        Ticket[] expected = {ticket10, ticket3, ticket8};
        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void managerFindOneTest() {
        ...
        Ticket[] actual = manager.findTickets("DME", "EVN");
        Ticket[] expected = {ticket5};
        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void managerFindNoOneTest() {
        ...
        Ticket[] actual = manager.findTickets("LED", "EVN");
        Ticket[] expected = {};
        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void managerAllSortedTicketsTest() {
        ...
        Ticket[] actual = manager.allSortedTickets();
